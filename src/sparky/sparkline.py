...
class Sparkline:
    ...
    def render(self, parent: ET.Element, spans: list[TokenBB], window: tuple[int, int], x=0.0, y=0.0, h=20.0):
        ...
        dx = 0.2
        Element(parent, "path",
            d=" ".join(f'M{first_char-dx:.1f},{h:.1f} L{last_char+dx:.1f},{h:.1f}' for first_char, last_char in segments),
            fill="none",
